Báo cáo chạy toàn bộ bộ kiểm thử Backend trên nhánh `test/T38-a903-kiem-hanh-vi`, sau khi ca `A-903`
đổi từ quét chuỗi sang kiểm hành vi và ca `A-903b` bỏ `Skip` để chạy thật.
...
Tổng 631 ca: 624 ĐẠT, 0 HỎNG, 7 bỏ qua.

So với lần chạy trước trên nhánh `fix/T36-sua-loi-qc-t27`: ca hỏng duy nhất đã xanh, `A-903b` chuyển
từ bỏ qua sang ĐẠT, và `main` mang thêm một ca mới cho danh sách đợt khi chưa cài đợt nào. Bảy ca bỏ
qua còn lại gồm sáu ca `A8DefectTests` thuộc vòng hồi quy T29 và một ca quét đồng hồ của `Core.QcTests`.
...
- 5.1 · Chưa cài đợt nào thì không báo khoảng trống, nhưng dải 12 tháng vẫn phủ trọn 01/01–31/12 — ĐẠT
...
- A903 · Ở Production biến ép ngày bị bỏ qua và vẫn ghi cảnh báo, ngoài Production biến ép được ngày, giá trị sai định dạng bị bỏ qua mà không sập, và ngoài hai file của tầng provider không nơi nào trong BE/src đọc biến này — ĐẠT
- A903b · Trên host giữ nguyên provider thời gian thật, đặt biến môi trường rồi gọi Dashboard thì hôm nay đúng bằng ngày bị ép — ĐẠT
