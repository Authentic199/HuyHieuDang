Báo cáo chạy toàn bộ bộ kiểm thử Backend sau khi sửa năm lỗi QC phát hiện ở T27 (task T36).
...
Tổng 488 ca: 485 ĐẠT, 2 HỎNG, 1 bỏ qua.
Hai ca hỏng đều có sẵn trên `main` trước khi T36 bắt đầu và nằm ngoài phạm vi task này.
...
- Chưa cài đợt nào thì cả năm mang nhãn "Sau đợt cuối cùng" — HỎNG: nhãn trả về là "Trước đợt đầu tiên" thay vì "Sau đợt cuối cùng" — lỗi có sẵn trên main, ngoài phạm vi T36
...
## HuyHieuDang.Core.QcTests — bộ kiểm chứng độc lập của QC
...
- QC-02 · Nhãn khoảng trống khi chưa cài đợt nào phải khớp expected.json — HỎNG: nhãn trả về là "Trước đợt đầu tiên" thay vì "Sau đợt cuối cùng" — lỗi có sẵn trên main, ngoài phạm vi T36
