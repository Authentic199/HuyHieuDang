import { EMPTY_MARK } from '../../utils/format';
import { milestoneScale, shadow } from '../../theme/tokens';

/**
 * Viên thuốc "N năm" của cột Mốc kế tiếp, màu lấy từ thang "Cool Waters" trong
 * artboard 0. Mốc lẻ dùng bậc của chục liền dưới: 35 năm dùng bậc 30.
 * Người đã vượt mốc lớn nhất (QT3a) không có mốc kế tiếp — hiện dấu gạch ngang.
 */
export function MilestoneTag({ milestone }: { milestone: number | null }) {
  if (milestone === null) return <>{EMPTY_MARK}</>;
